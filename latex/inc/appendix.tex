...
\begin{lstlisting}[language=json,firstnumber=1, 
  caption={Configuration file for scenario 2
  },captionpos=b,label={scenario2config}]
{
  "seeds": [6,7,8,9,10],
  "network":{
    "nodes": 1000,
...
\begin{lstlisting}[language=json,firstnumber=1, 
  caption={Configuration file for scenario 3
  },captionpos=b,label={scenario3config}]
