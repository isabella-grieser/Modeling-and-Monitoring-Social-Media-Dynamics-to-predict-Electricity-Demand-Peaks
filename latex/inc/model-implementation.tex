...
to provide more realistic simulation results. %talk about the will act etc
...
in a JSON-file. An exmple JSON is shown in Listing 
...
model generation
such as $\alpha$, $\beta$ and $p<p_{will\_act}$ 
are defined.
...
parameter \code{power\_threshold}.


%other todos
%simulation steps itself
%with pseudocode?
% the reference data is important
%the args file with all important parameters
